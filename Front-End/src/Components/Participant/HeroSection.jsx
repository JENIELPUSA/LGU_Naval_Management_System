...
const HeroSection = ({ setShowModal }) => {
  ...
  return (
    <motion.section
      ref={heroRef}
      style={{ y, opacity }}
      className="relative mb-20 overflow-hidden h-screen flex items-center justify-center"
    >
      {/* Backgrounds */}
      ...
      <div className="relative z-10 px-8 text-center md:px-16">
        <div className="mx-auto max-w-4xl">
          ...
          >
            The most advanced platform for planning, managing, and monitoring
            events in your local government.
          </motion.p>
