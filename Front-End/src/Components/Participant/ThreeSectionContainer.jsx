...
const ThreeSectionContainer = ({ eventsRef, isEventUpcoming, setShowModal, handleEventSelect }) => {
  ...
  return (
    <section 
      className={`relative w-full min-h-screen ${colors.background} py-12`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 
            ...
            className={`${getTextSizeClass('3')} sm:text-4xl font-bold ${colors.textPrimary} mb-4 tracking-tight leading-tight`}
        ...
        >
          ...
          >
            <div className={`rounded-lg ${colors.shadow} ${colors.cardBackground} ${colors.border} ${
          ...
          >
            <div className={`rounded-lg ${colors.shadow} ${colors.border} ${
              accessibility.isHighContrast ? 'border-2 border-gray-700' : 'border border-gray-200'
            }`}>
              <LatestEvent
                eventsRef={eventsRef}
