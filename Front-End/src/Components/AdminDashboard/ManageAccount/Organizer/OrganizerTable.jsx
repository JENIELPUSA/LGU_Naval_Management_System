...
const OrganizerTable = ({ data }) => {
    ...
    const [tempSearchTerm, setTempSearchTerm] = useState(""); // New temporary search state
    const [searchTerm, setSearchTerm] = useState(""); // Actual search term used in API calls
