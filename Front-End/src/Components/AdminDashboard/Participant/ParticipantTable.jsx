...
import { Database, Trash, Plus, User, Calendar, Clock, Search } from "lucide-react";
...
const ParticipantTable = () => {
    ...
    return (
        <>
            ...
            {/* ✅ Simplified background for mobile - same as EventTable and ProposalTable */}
            <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
                {/* Header - same structure as EventTable */}
                <div className="sticky top-0 z-10 border-b border-gray-200 bg-white/90 backdrop-blur dark:border-gray-700 dark:bg-slate-900/90">
                    <div className="px-2 py-3 sm:px-4 sm:py-4">
                        <div className="flex flex-col gap-2">
                            ...
                            {/* Search & Filters - stacked on mobile, same as EventTable */}
                            ...
                            {/* Event Filter - separate row for mobile */}
                ...
                {/* Content - card structure instead of table for mobile */}
                <div className="px-2 py-3 sm:px-4 sm:py-4">
                                            ...
                                            {role === "admin" && (
                                                <div className="mt-2 flex justify-end">
                                                    <button
                                                        ...
                                                        className="flex items-center gap-1 rounded bg-red-50 px-1.5 py-0.5 text-[10px] text-red-600 hover:bg-red-100 dark:bg-red-900/30 dark:text-red-400 sm:gap-1.5 sm:px-2 sm:py-1 sm:text-xs"
                                                    >
                                                        <Trash size={10} className="sm:size-3" /> Delete
                                                    </button>
                                                </div>
                                            )}
                                        </div>
                ...
                {/* Pagination - compact on mobile, same as EventTable */}
                {totalPages > 1 && (
